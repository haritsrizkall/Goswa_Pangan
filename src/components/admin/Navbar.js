...
const navigation = [
  { name: "Pasar", href: "/dashboard/pasar" },
  { name: "Komoditas", href: "/dashboard/komoditas" },
  { name: "Harga", href: "/dashboard/harga" },
];
  ...
  return (
    <nav className="bg-white/95 backdrop-blur-sm fixed w-full z-20 top-0 border-b">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3">
        {/* Logo */}
        <Link href="/pasar" className="flex items-center gap-2">
          <Image
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="right" className="w-72">
            ...
            <nav className="flex flex-col gap-1 mt-4">
              ...
              <Button className="mt-4 rounded-full w-full">Hubungi Kami</Button>
            </nav>
          </SheetContent>
        </Sheet>
      </div>
